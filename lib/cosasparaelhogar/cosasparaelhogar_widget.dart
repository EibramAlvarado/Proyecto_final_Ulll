...
class CosasparaelhogarWidget extends StatefulWidget {
  const CosasparaelhogarWidget({Key key}) : super(key: key);

  @override
  _CosasparaelhogarWidgetState createState() => _CosasparaelhogarWidgetState();
}

class _CosasparaelhogarWidgetState extends State<CosasparaelhogarWidget> {
