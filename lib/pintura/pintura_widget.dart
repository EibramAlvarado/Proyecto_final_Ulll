...
class PinturaWidget extends StatefulWidget {
  const PinturaWidget({Key key}) : super(key: key);

  @override
  _PinturaWidgetState createState() => _PinturaWidgetState();
}

class _PinturaWidgetState extends State<PinturaWidget> {
